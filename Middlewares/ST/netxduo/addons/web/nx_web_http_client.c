...
UINT  _nxe_web_http_client_patch_secure_start(NX_WEB_HTTP_CLIENT *client_ptr, NXD_ADDRESS *server_ip, UINT server_port, CHAR *resource,
                                             CHAR *host, CHAR *username, CHAR *password, ULONG total_bytes,
                                             UINT (*tls_setup)(NX_WEB_HTTP_CLIENT *client_ptr, NX_SECURE_TLS_SESSION *),
                                             ULONG wait_option)
{
UINT status;
    ...
    /* Call actual POST start routine.  */
    status =  _nx_web_http_client_patch_secure_start(client_ptr, server_ip, server_port, resource, host,
                                                    username, password, total_bytes, tls_setup, wait_option);
...
UINT  _nx_web_http_client_patch_secure_start(NX_WEB_HTTP_CLIENT *client_ptr, NXD_ADDRESS *server_ip, UINT server_port, CHAR *resource,
                                            CHAR *host, CHAR *username, CHAR *password, ULONG total_bytes,
                                            UINT (*tls_setup)(NX_WEB_HTTP_CLIENT *client_ptr, NX_SECURE_TLS_SESSION *),
                                            ULONG wait_option)
{
...
UINT temp_password_length = 0;
    ...
    return(_nx_web_http_client_patch_secure_start_extended(client_ptr, server_ip, server_port,
                                                          resource, temp_resource_length, host,
                                                          temp_host_length, username,
                                                          temp_username_length, password,
                                                          temp_password_length, total_bytes,
...
UINT _nxe_web_http_client_patch_secure_start_extended(NX_WEB_HTTP_CLIENT *client_ptr, NXD_ADDRESS *server_ip, UINT server_port,
                                                     CHAR *resource, UINT resource_length, CHAR *host, UINT host_length,
                                                     CHAR *username, UINT username_length, CHAR *password,
                                                     UINT password_length, ULONG total_bytes,
                                                     UINT (*tls_setup)(NX_WEB_HTTP_CLIENT *client_ptr, NX_SECURE_TLS_SESSION *),
...
UINT status;
    ...
    /* Call actual POST start routine.  */
    status = _nx_web_http_client_patch_secure_start_extended(client_ptr, server_ip, server_port,
                                                            resource, resource_length, host,
                                                            host_length, username, username_length,
                                                            password, password_length, total_bytes,
                                                            tls_setup, wait_option);
...
UINT _nx_web_http_client_patch_secure_start_extended(NX_WEB_HTTP_CLIENT *client_ptr, NXD_ADDRESS *server_ip, UINT server_port,
                                                    CHAR *resource, UINT resource_length, CHAR *host, UINT host_length,
                                                    CHAR *username, UINT username_length, CHAR *password,
                                                    UINT password_length, ULONG total_bytes,
                                                    UINT (*tls_setup)(NX_WEB_HTTP_CLIENT *client_ptr, NX_SECURE_TLS_SESSION *),
...
UINT        status;
    ...
    /* Enter the POST state.  */
    client_ptr -> nx_web_http_client_state =  NX_WEB_HTTP_CLIENT_STATE_PATCH;
...
UINT        string2_length;
    ...
    case NX_WEB_HTTP_METHOD_HEAD:
        ...
        nx_packet_data_append(packet_ptr, "HEAD ", 5, client_ptr -> nx_web_http_client_packet_pool_ptr,
                              wait_option);
        break;
    case NX_WEB_HTTP_METHOD_PATCH:
		/* Build the PATCH request.  */
		nx_packet_data_append(packet_ptr, "PATCH ", 6, client_ptr -> nx_web_http_client_packet_pool_ptr,
							  wait_option);
		break;
    case NX_WEB_HTTP_METHOD_NONE:
    default:
